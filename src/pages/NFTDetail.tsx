...
const generateSeed = (address: string): number => {
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-6 mb-6">
                            ...
                            <Avatar className="h-8 w-8 hover:ring-2 hover:ring-primary transition-all cursor-pointer">
                              {creatorProfile?.profileImage ? (
                                ...
                                <div className="w-full h-full">
                                  <Jazzicon diameter={32} address={nft.creator} />
                                </div>
                              )}
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-2">
                          ...
                          <Link to={`/profile/${nft.owner}`}>
                            <Avatar className="h-8 w-8 hover:ring-2 hover:ring-primary transition-all cursor-pointer">
                              {ownerProfile?.profileImage ? (
                                ...
                                <div className="w-full h-full">
                                  <Jazzicon diameter={32} address={nft.owner} />
                                </div>
                              )}
                    ...
                    <a 
                      href={`https://giant-half-dual-testnet.explorer.testnet.skalenodes.com/address/${nft.owner}`} 
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-medium text-blue-500 hover:underline"
                    >
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between mt-1">
                  <p className="text-sm">
                    <a 
                      href={`https://giant-half-dual-testnet.explorer.testnet.skalenodes.com/address/${tx.from}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a 
                      href={`https://giant-half-dual-testnet.explorer.testnet.skalenodes.com/address/${tx.to}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-500 hover:underline"
                    >
